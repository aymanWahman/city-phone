...
const Page = () => {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 p-5 mt-32 text-center items-center">

        <div className=' items-center col-span-1 mx-auto justify-center'>
   ...
   {/* <div className=" rounded-xl mx-auto text-center ">
        ...
        <div className="col-span-2 w-full py-16 rounded-xl space-y-4 border-2 border-orange-600">
